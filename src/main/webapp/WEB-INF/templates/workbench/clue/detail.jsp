	...
	<head>
		...
		<script type="text/javascript">
            ...
            $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.code == "1") {
                                ...
                                window.location.href = "workbench/clue/detailOfClue.do?clueId=" + clueId;
                            } else {
                                alert(data.message);
                            }
                        }
                ...
                <!-- "关联市场活动"单击事件 -->
                $("#createRelationA").click(function () {
                ...
                <!-- "关联"按钮 -->
                $("#saveCreateRelationBtn").click(function () {
                ...
                $("#relationTBody").on("click", "a", function () {
                    ...
                    if (window.confirm("确定解除关联?")) {
                        $.ajax({
                            url: 'workbench/clue/saveRemoveClueActivityRelation.do',
                            data: {
	...
	<body>
			...
			<div class="modal-dialog" role="document" style="width: 80%;">
				<div class="modal-content">
						...
						<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
							<form class="form-inline" role="form">
								<div class="form-group has-feedback">
									<input id="queryContent" type="text" class="form-control" style="width: 300px;"
					...
					<div class="modal-footer">
						<button type="button" data-toggle="modal" data-target="#bundModal">取消</button>
						<button id="saveCreateRelationBtn" type="button">关联</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div style="position: relative; top: 40px; left: 40px;">
			...
			<c:forEach items="${clueRemarkList}" var="clueRemark">
				<div class="remarkDiv" style="height: 60px;">
					<img title="${clueRemark.createBy}" src="image/user-thumbnail.png"
					...
					<div style="position: relative; top: -40px; left: 40px;">
						...
						<small style="color: gray;">
							<c:if test="${clueRemark.editFlag==0}">${clueRemark.createTime} 由${clueRemark.createBy}发表</c:if>
							<c:if test="${clueRemark.editFlag==1}">${clueRemark.editTime} 由${clueRemark.editBy}修改</c:if>
						</small>
		...
		<div>
			<div style="position: relative; top: 60px; left: 40px;">
					...
					<table class="table table-hover" style="width: 900px;">
						...
						<c:forEach items="${activityList}" var="activity">
							<tr id="tr_${activity.id}">
								...
								<td>
									<a href="javascript:void(0);" activityId="${activity.id}"
				...
				<div>
					<a id="createRelationA" style="text-decoration: none;"><span
